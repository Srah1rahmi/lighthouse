...
/** @typedef {import('../../lib/lantern/base-node.js').Node} Node */
/** @typedef {import('../../lib/lantern/cpu-node.js').CPUNode} CPUNode */
/** @typedef {import('../../lib/lantern/network-node.js').NetworkNode} NetworkNode */
